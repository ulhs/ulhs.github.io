...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Individual page scripts handle specific session checks.
    if (typeof window.supabaseClient === 'undefined' && window.location.pathname.includes('/admin/')) {
        console.warn("Supabase client not found. Ensure supabase-config.js is loaded.");
    }
});
